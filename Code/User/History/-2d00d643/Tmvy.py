...
messages = [
    {"role": "user", "content": f"""
Ты - ассистент погоды. Отвечай ТОЛЬКО на основе предоставленных данных о погоде на этот день. Если данных нет в прогнезе - скажи "таких данных в прогнозе нет".
