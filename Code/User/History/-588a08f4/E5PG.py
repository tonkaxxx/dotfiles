...
async def all_messages(message: types.Message):
    ...
    thoughts = user_data[thoughts]
    exams = user_data[exams]
    programming = user_data[programming]
    lenses = user_data[lenses]
    await message.answer(f"sleep: {sleep}hrs, thoughts: {thoughts}, exams: {exams}, programming: {programming}, lenses: {lenses}")
